...
BINARY_SENSOR_MACBOOK_PRO_2_ACTIVE: Entity = Entity("binary_sensor.macbook_pro_2_active")
BINARY_SENSOR_MACBOOK_PRO_2_AUDIO_INPUT_IN_USE: Entity = Entity("binary_sensor.macbook_pro_2_audio_input_in_use")
BINARY_SENSOR_MACBOOK_PRO_2_AUDIO_OUTPUT_IN_USE: Entity = Entity("binary_sensor.macbook_pro_2_audio_output_in_use")
BINARY_SENSOR_MACBOOK_PRO_2_CAMERA_IN_USE: Entity = Entity("binary_sensor.macbook_pro_2_camera_in_use")
BINARY_SENSOR_MACBOOK_PRO_2_FOCUS: Entity = Entity("binary_sensor.macbook_pro_2_focus")
...
SENSOR_MACBOOK_PRO_2_ACTIVE_AUDIO_INPUT: Entity = Entity("sensor.macbook_pro_2_active_audio_input")
SENSOR_MACBOOK_PRO_2_ACTIVE_AUDIO_OUTPUT: Entity = Entity("sensor.macbook_pro_2_active_audio_output")
SENSOR_MACBOOK_PRO_2_ACTIVE_CAMERA: Entity = Entity("sensor.macbook_pro_2_active_camera")
SENSOR_MACBOOK_PRO_2_BSSID: Entity = Entity("sensor.macbook_pro_2_bssid")
SENSOR_MACBOOK_PRO_2_CONNECTION_TYPE: Entity = Entity("sensor.macbook_pro_2_connection_type")
SENSOR_MACBOOK_PRO_2_DISPLAYS: Entity = Entity("sensor.macbook_pro_2_displays")
SENSOR_MACBOOK_PRO_2_FRONTMOST_APP: Entity = Entity("sensor.macbook_pro_2_frontmost_app")
SENSOR_MACBOOK_PRO_2_GEOCODED_LOCATION: Entity = Entity("sensor.macbook_pro_2_geocoded_location")
SENSOR_MACBOOK_PRO_2_INTERNAL_BATTERY_LEVEL: Entity = Entity("sensor.macbook_pro_2_internal_battery_level")
SENSOR_MACBOOK_PRO_2_INTERNAL_BATTERY_STATE: Entity = Entity("sensor.macbook_pro_2_internal_battery_state")
SENSOR_MACBOOK_PRO_2_LAST_UPDATE_TRIGGER: Entity = Entity("sensor.macbook_pro_2_last_update_trigger")
SENSOR_MACBOOK_PRO_2_PRIMARY_DISPLAY_ID: Entity = Entity("sensor.macbook_pro_2_primary_display_id")
SENSOR_MACBOOK_PRO_2_PRIMARY_DISPLAY_NAME: Entity = Entity("sensor.macbook_pro_2_primary_display_name")
SENSOR_MACBOOK_PRO_2_SSID: Entity = Entity("sensor.macbook_pro_2_ssid")
SENSOR_MACBOOK_PRO_2_STORAGE: Entity = Entity("sensor.macbook_pro_2_storage")
...
SENSOR_WARDROBE_BATTERY: Entity = Entity("sensor.wardrobe_battery")
...
UPDATE_GLANCES_UPDATE: Entity = Entity("update.glances_update")
