...
OCTOPUS_ENERGY_BOOST_HEAT_PUMP_ZONE: Service = Service("octopus_energy/boost_heat_pump_zone")
...
OCTOPUS_ENERGY_SET_HEAT_PUMP_FLOW_TEMP_CONFIG: Service = Service("octopus_energy/set_heat_pump_flow_temp_config")
