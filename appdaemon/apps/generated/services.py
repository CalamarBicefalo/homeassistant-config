...
MASS_GET_LIBRARY: Service = Service("mass/get_library")
MASS_GET_QUEUE: Service = Service("mass/get_queue")
MASS_PLAY_ANNOUNCEMENT: Service = Service("mass/play_announcement")
MASS_PLAY_MEDIA: Service = Service("mass/play_media")
MASS_SEARCH: Service = Service("mass/search")
MASS_TRANSFER_QUEUE: Service = Service("mass/transfer_queue")
...
OCTOPUS_ENERGY_DIAGNOSE_HEATPUMP_APIS: Service = Service("octopus_energy/diagnose_heatpump_apis")
