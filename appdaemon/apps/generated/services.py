...
AI_TASK_GENERATE_DATA: Service = Service("ai_task/generate_data")
AI_TASK_GENERATE_IMAGE: Service = Service("ai_task/generate_image")
...
BERMUDA_DUMP_DEVICES: Service = Service("bermuda/dump_devices")
BLUEPRINT_IMPORT: Service = Service("blueprint/import")
...
DATE_SET_VALUE: Service = Service("date/set_value")
DATETIME_SET_VALUE: Service = Service("datetime/set_value")
...
ESPHOME_EVERYTHING_PRESENCE_PRO_DA42EC_GET_BUILD_FLAGS: Service = Service("esphome/everything_presence_pro_da42ec_get_build_flags")
ESPHOME_EVERYTHING_PRESENCE_PRO_DA42EC_SET_UPDATE_MANIFEST: Service = Service("esphome/everything_presence_pro_da42ec_set_update_manifest")
...
HASSIO_APP_RESTART: Service = Service("hassio/app_restart")
HASSIO_APP_START: Service = Service("hassio/app_start")
HASSIO_APP_STDIN: Service = Service("hassio/app_stdin")
HASSIO_APP_STOP: Service = Service("hassio/app_stop")
...
HASSIO_MOUNT_RELOAD: Service = Service("hassio/mount_reload")
HASSIO_RESTORE_FULL: Service = Service("hassio/restore_full")
HASSIO_RESTORE_PARTIAL: Service = Service("hassio/restore_partial")
HOME_CONNECT_CHANGE_SETTING: Service = Service("home_connect/change_setting")
HOME_CONNECT_SET_PROGRAM_AND_OPTIONS: Service = Service("home_connect/set_program_and_options")
HOME_CONNECT_START_SELECTED_PROGRAM: Service = Service("home_connect/start_selected_program")
HOMEASSISTANT_ADD_ALIAS_TO_AREA: Service = Service("homeassistant/add_alias_to_area")
HOMEASSISTANT_ADD_ALIAS_TO_FLOOR: Service = Service("homeassistant/add_alias_to_floor")
HOMEASSISTANT_ADD_AREA_TO_FLOOR: Service = Service("homeassistant/add_area_to_floor")
HOMEASSISTANT_ADD_DEVICE_TO_AREA: Service = Service("homeassistant/add_device_to_area")
HOMEASSISTANT_ADD_ENTITY_TO_AREA: Service = Service("homeassistant/add_entity_to_area")
HOMEASSISTANT_ADD_LABEL_TO_AREA: Service = Service("homeassistant/add_label_to_area")
HOMEASSISTANT_ADD_LABEL_TO_DEVICE: Service = Service("homeassistant/add_label_to_device")
HOMEASSISTANT_ADD_LABEL_TO_ENTITY: Service = Service("homeassistant/add_label_to_entity")
HOMEASSISTANT_CHECK_CONFIG: Service = Service("homeassistant/check_config")
HOMEASSISTANT_CREATE_AREA: Service = Service("homeassistant/create_area")
HOMEASSISTANT_CREATE_FLOOR: Service = Service("homeassistant/create_floor")
HOMEASSISTANT_CREATE_LABEL: Service = Service("homeassistant/create_label")
HOMEASSISTANT_DELETE_ALL_ORPHANED_ENTITIES: Service = Service("homeassistant/delete_all_orphaned_entities")
HOMEASSISTANT_DELETE_AREA: Service = Service("homeassistant/delete_area")
HOMEASSISTANT_DELETE_FLOOR: Service = Service("homeassistant/delete_floor")
HOMEASSISTANT_DELETE_LABEL: Service = Service("homeassistant/delete_label")
HOMEASSISTANT_DISABLE_CONFIG_ENTRY: Service = Service("homeassistant/disable_config_entry")
HOMEASSISTANT_DISABLE_DEVICE: Service = Service("homeassistant/disable_device")
HOMEASSISTANT_DISABLE_ENTITY: Service = Service("homeassistant/disable_entity")
HOMEASSISTANT_DISABLE_POLLING: Service = Service("homeassistant/disable_polling")
HOMEASSISTANT_DISABLE_USER: Service = Service("homeassistant/disable_user")
HOMEASSISTANT_ENABLE_CONFIG_ENTRY: Service = Service("homeassistant/enable_config_entry")
HOMEASSISTANT_ENABLE_DEVICE: Service = Service("homeassistant/enable_device")
HOMEASSISTANT_ENABLE_ENTITY: Service = Service("homeassistant/enable_entity")
HOMEASSISTANT_ENABLE_POLLING: Service = Service("homeassistant/enable_polling")
HOMEASSISTANT_ENABLE_USER: Service = Service("homeassistant/enable_user")
HOMEASSISTANT_HIDE_ENTITY: Service = Service("homeassistant/hide_entity")
HOMEASSISTANT_IGNORE_ALL_DISCOVERED: Service = Service("homeassistant/ignore_all_discovered")
HOMEASSISTANT_LIST_ORPHANED_DATABASE_ENTITIES: Service = Service("homeassistant/list_orphaned_database_entities")
...
HOMEASSISTANT_REMOVE_ALIAS_FROM_AREA: Service = Service("homeassistant/remove_alias_from_area")
HOMEASSISTANT_REMOVE_ALIAS_FROM_FLOOR: Service = Service("homeassistant/remove_alias_from_floor")
HOMEASSISTANT_REMOVE_AREA_FROM_FLOOR: Service = Service("homeassistant/remove_area_from_floor")
HOMEASSISTANT_REMOVE_DEVICE_FROM_AREA: Service = Service("homeassistant/remove_device_from_area")
HOMEASSISTANT_REMOVE_ENTITY_FROM_AREA: Service = Service("homeassistant/remove_entity_from_area")
HOMEASSISTANT_REMOVE_LABEL_FROM_AREA: Service = Service("homeassistant/remove_label_from_area")
HOMEASSISTANT_REMOVE_LABEL_FROM_DEVICE: Service = Service("homeassistant/remove_label_from_device")
HOMEASSISTANT_REMOVE_LABEL_FROM_ENTITY: Service = Service("homeassistant/remove_label_from_entity")
HOMEASSISTANT_RENAME_ENTITY: Service = Service("homeassistant/rename_entity")
...
HOMEASSISTANT_SET_AREA_ALIASES: Service = Service("homeassistant/set_area_aliases")
HOMEASSISTANT_SET_FLOOR_ALIASES: Service = Service("homeassistant/set_floor_aliases")
...
HOMEASSISTANT_UNHIDE_ENTITY: Service = Service("homeassistant/unhide_entity")
HOMEASSISTANT_UPDATE_ENTITY: Service = Service("homeassistant/update_entity")
HOMEASSISTANT_UPDATE_ENTITY_ID: Service = Service("homeassistant/update_entity_id")
...
IMAGE_PROCESSING_SCAN: Service = Service("image_processing/scan")
...
INPUT_NUMBER_CREATE: Service = Service("input_number/create")
INPUT_NUMBER_DECREMENT: Service = Service("input_number/decrement")
INPUT_NUMBER_DELETE: Service = Service("input_number/delete")
INPUT_NUMBER_INCREMENT: Service = Service("input_number/increment")
INPUT_NUMBER_MAX: Service = Service("input_number/max")
INPUT_NUMBER_MIN: Service = Service("input_number/min")
INPUT_NUMBER_RELOAD: Service = Service("input_number/reload")
INPUT_NUMBER_SET_VALUE: Service = Service("input_number/set_value")
INPUT_SELECT_RANDOM: Service = Service("input_select/random")
...
INPUT_SELECT_SHUFFLE: Service = Service("input_select/shuffle")
INPUT_SELECT_SORT: Service = Service("input_select/sort")
...
MATTER_CLEAR_LOCK_CREDENTIAL: Service = Service("matter/clear_lock_credential")
MATTER_CLEAR_LOCK_USER: Service = Service("matter/clear_lock_user")
MATTER_GET_LOCK_CREDENTIAL_STATUS: Service = Service("matter/get_lock_credential_status")
MATTER_GET_LOCK_INFO: Service = Service("matter/get_lock_info")
MATTER_GET_LOCK_USERS: Service = Service("matter/get_lock_users")
MATTER_SET_LOCK_CREDENTIAL: Service = Service("matter/set_lock_credential")
MATTER_SET_LOCK_USER: Service = Service("matter/set_lock_user")
...
NOTIFY_ALL_WEARABLES: Service = Service("notify/all_wearables")
NOTIFY_MOBILE_APP_AMANDA_M1AIR_C02FX084Q6LX: Service = Service("notify/mobile_app_amanda_m1air_c02fx084q6lx")
NOTIFY_MOBILE_APP_AMANDAS_PERSONAL_MAC: Service = Service("notify/mobile_app_amandas_personal_mac")
NOTIFY_MOBILE_APP_AMANDAS_SEGB_LAPTOP: Service = Service("notify/mobile_app_amandas_segb_laptop")
...
NOTIFY_MOBILE_APP_MANDIE_S_PHONE: Service = Service("notify/mobile_app_mandie_s_phone")
...
NUMBER_DECREMENT: Service = Service("number/decrement")
NUMBER_INCREMENT: Service = Service("number/increment")
NUMBER_MAX: Service = Service("number/max")
NUMBER_MIN: Service = Service("number/min")
...
PERSON_ADD_DEVICE_TRACKER: Service = Service("person/add_device_tracker")
PERSON_RELOAD: Service = Service("person/reload")
PERSON_REMOVE_DEVICE_TRACKER: Service = Service("person/remove_device_tracker")
...
RECORDER_IMPORT_STATISTICS: Service = Service("recorder/import_statistics")
...
REPAIRS_CREATE: Service = Service("repairs/create")
REPAIRS_IGNORE_ALL: Service = Service("repairs/ignore_all")
REPAIRS_REMOVE: Service = Service("repairs/remove")
REPAIRS_UNIGNORE_ALL: Service = Service("repairs/unignore_all")
...
SELECT_RANDOM: Service = Service("select/random")
...
SPOOK_BOO: Service = Service("spook/boo")
SPOOK_RANDOM_FAIL: Service = Service("spook/random_fail")
...
TIMER_SET_DURATION: Service = Service("timer/set_duration")
...
TUYA_GET_FEEDER_MEAL_PLAN: Service = Service("tuya/get_feeder_meal_plan")
TUYA_SET_FEEDER_MEAL_PLAN: Service = Service("tuya/set_feeder_meal_plan")
...
VACUUM_CLEAN_AREA: Service = Service("vacuum/clean_area")
...
ZONE_CREATE: Service = Service("zone/create")
ZONE_DELETE: Service = Service("zone/delete")
ZONE_RELOAD: Service = Service("zone/reload")
ZONE_UPDATE: Service = Service("zone/update")
