...
class BedroomScene(SceneApp):
    brightness_sensor = entities.SENSOR_BEDROOM_BRIGHTNESS
    ...
    def prepare_to_wake_up(self) -> None:
        ...
        def after_wakeup() -> None:
            self.run_in(lambda *_: self.handlers.music.play(Playlist.LATIN_JAZZ, shuffle=True, volume_level=0.3), 60)
